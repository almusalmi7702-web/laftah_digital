...
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center whatsapp-btn transition-all duration-300 hover:scale-110 ${
