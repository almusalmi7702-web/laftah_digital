...
const StoryCard = ({ icon, title, text, color }: StoryCardProps) => {
  ...
  return (
    <div
      ref={ref}
      className={`bg-white rounded-2xl p-8 shadow-sm border border-gray-100 text-right transition-all duration-700 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
    >
