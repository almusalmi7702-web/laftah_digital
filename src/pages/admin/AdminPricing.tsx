  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <a href="/admin/pricing/new" className="inline-flex items-center gap-2 bg-gradient-to-l from-teal-500 to-teal-600 text-white px-5 py-2.5 rounded-lg font-semibold text-sm hover:shadow-lg transition-all">
      ...
      {items.length === 0 ? (
        <div className="bg-white rounded-xl p-12 text-center border border-gray-100">
          ...
          <p className="text-gray-500">ابدأ بإضافة أول باقة</p>
        </div>
      ) : (
