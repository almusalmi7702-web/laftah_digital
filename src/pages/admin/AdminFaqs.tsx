            ...
            <div className="bg-white rounded-xl p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button type="submit" disabled={saving} className="flex-1 px-4 py-2.5 bg-teal-500 text-white rounded-lg font-semibold hover:bg-teal-600 disabled:opacity-50 flex items-center justify-center gap-2">
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[600px]">
                <thead className="bg-gray-50 border-b border-gray-100">
                  <tr>
                    <th className="text-right px-6 py-4 font-semibold text-navy-800 whitespace-nowrap">السؤال</th>
