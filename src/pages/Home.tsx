...
const Hero = () => {
  ...
  return (
    <section className="pt-20 xl:min-h-screen bg-gradient-to-bl from-gray-50 via-white to-teal-50/30 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 xl:py-24" ref={ref}>
        <div className="grid xl:grid-cols-2 gap-10 xl:gap-16 items-center">
          {/* Content */}
          <div className="order-2 xl:order-2 text-right">
          ...
          <div className={`order-1 xl:order-1 transition-all duration-700 delay-200 ${isInView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="relative">
              ...
              <div className="mt-4 w-fit bg-white rounded-2xl p-4 shadow-xl border border-gray-100 sm:absolute sm:mt-0 sm:-bottom-4 sm:-left-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-teal-50 rounded-lg flex items-center justify-center">
        ...
        {loading ? (
          ...
          <div className="grid md:grid-cols-3 gap-8 items-start">
            {preview.map((pkg, i) => {
              ...
              const message = `مرحبًا، أريد الاشتراك في ${name} من لفتة ديجيتال.`;
