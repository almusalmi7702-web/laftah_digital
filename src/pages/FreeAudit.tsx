...
const FreeAudit = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const message = projectName || accountUrl
      ? `مرحبًا، أريد الحصول على تقييم بصري مجاني.\nاسم المشروع: ${projectName}\nرابط الحساب: ${accountUrl}`
      : `مرحبًا، أريد الحصول على تقييم بصري مجاني لحسابي.`;
    ...
    <div className="pt-20">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-12 transition-all duration-700 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full inline-flex items-center justify-center gap-2 bg-gradient-to-l from-teal-500 to-teal-600 text-white px-8 py-4 rounded-xl font-bold text-base hover:shadow-xl hover:shadow-teal-500/30 transition-all duration-300 hover:-translate-y-0.5"
              >
